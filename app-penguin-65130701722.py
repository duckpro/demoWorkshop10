...
# Load model
with open('model-penguin-65130701722.pkl', 'rb') as file:
...
culmen_depth_input = st.slider('Enter culmen depth in mm (0 to 50):',min_value=0, max_value=200, 100)
flipper_length_input = st.slider('Enter flipper length in mm (0 to 200):', min_value=0, max_value=200,100)
